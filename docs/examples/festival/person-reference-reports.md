...
```bash
nql docs/examples/festival/person-resource-chart.nql
```
...
```bash
nql docs/examples/festival/person-festival-summary.nql
```
...
```bash
nql docs/examples/festival/person-work-chart.nql
nql docs/examples/festival/person-work-chart.nql --param personId=PER004
```
