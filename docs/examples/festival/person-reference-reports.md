...
```bash
nq docs/examples/festival/person-resource-chart.nq
```
...
```bash
nq docs/examples/festival/person-festival-summary.nq
```
...
```bash
nq docs/examples/festival/person-work-chart.nq
nq docs/examples/festival/person-work-chart.nq --param personId=PER004
```
