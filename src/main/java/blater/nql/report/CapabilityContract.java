...
/** The compiled, versioned contract exposed by {@code nql capabilities}. */
public final class CapabilityContract {
  ...
  private static List<?> commands() {
    return List.of(
        command("run", "nql [run] <script> [<data>] [options]",
            List.of("script", "data"), "optional-data", "result", "json"),
        command("convert", "nql convert [<data>] [options]",
            List.of("data"), "data", "result", "json"),
        command("catalog", "nql catalog [<data>] [<pattern>] [options]",
            List.of("data", "pattern"), "optional-data", "report", "markdown"),
        command("cache.load", "nql cache load [<data>] [<name>] [options]",
            List.of("data", "name"), "data", "report", "markdown"),
        command("cache.use", "nql cache use <name> [options]",
            List.of("name"), "ignored", "report", "markdown"),
        command("cache.list", "nql cache list [options]",
            List.of(), "ignored", "report", "markdown"),
        command("cache.clear", "nql cache clear (<name> | olderthan <age> | all) [options]",
            List.of("target"), "ignored", "report", "markdown"),
        command("capabilities", "nql capabilities [-r <format>]",
            List.of(), "ignored", "report", "json"),
        command("help", "nql help [<command> [<subcommand>]]",
            List.of("topic"), "ignored", "text", "text"),
        command("version", "nql version",
  ...
  private static Map<String, ?> cache() {
    return map(
        ...
        "environment_variable", "NQL_CACHE_DIR",
        "generated_identity_column", "_nql_id",
        "reserved_column_prefix", "_nql_",
